...
[![Go Report Card](https://goreportcard.com/badge/github.com/yinnyC/makesite)](https://goreportcard.com/report/github.com/yinnyC/makesite)
...
- [ ] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] I will use the github.com/fatih/color library. The documentation is located at  https://github.com/fatih/color. My goal is to use it to style terminal output.
